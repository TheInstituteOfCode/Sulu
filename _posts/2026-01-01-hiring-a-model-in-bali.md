...
[Plan your shoot](https://suluhstudio.com/contact){: .underline.underline.underline-offset-2.decoration-1.decoration-current/40.hover:decoration-current.focus:decoration-current} or [book a complimentary call](https://calendly.com/hello-gv4/intro-call){: .underline.underline.underline-offset-2.decoration-1.decoration-current/40.hover:decoration-current.focus:decoration-current} with one of our producers to talk through casting and what your shoot needs.

---

*Suluh Studios is a purpose-built indoor and outdoor photography studio in Cemagi, Bali, available as a studio rental or full-service production studio for lookbook, e-commerce, campaign, and lifestyle photography.* [*suluhstudio.com*](https://suluhstudio.com/){: .underline.underline.underline-offset-2.decoration-1.decoration-current/40.hover:decoration-current.focus:decoration-current}